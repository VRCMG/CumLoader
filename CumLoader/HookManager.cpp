...
void* HookManager::Hooked_runtime_invoke(const void* method, void* obj, void** params, void** exc)
{
	...
	if ((strstr(method_name, "Internal_ActiveSceneChanged") != NULL) || (!CumLoader::IsGameIl2Cpp && (strstr(method_name, "UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize") != NULL)))
	{
		if (CumLoader::IsGameIl2Cpp)
