...
namespace CumLoader
{
    public class CumConsole
    {
        ...
        private static void Create()
        {
            Enabled = true;
            Allocate();
            Console.SetOut(new StreamWriter(new FileStream(new SafeFileHandle(CumLogger.Native_GetConsoleOutputHandle(), false), FileAccess.Write)) { AutoFlush = true });
