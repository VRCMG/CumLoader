...
using CumLoader.ICSharpCode.SharpZipLib.Encryption;
#endif

using CumLoader.ICSharpCode.SharpZipLib.Core;
using CumLoader.ICSharpCode.SharpZipLib.Checksums;
using CumLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using CumLoader.ICSharpCode.SharpZipLib.Zip.Compression;

namespace CumLoader.ICSharpCode.SharpZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="CumLoader.ICSharpCode.SharpZipLib.Zip.ZipException">
