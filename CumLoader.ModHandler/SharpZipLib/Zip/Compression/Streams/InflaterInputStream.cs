...
namespace CumLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="CumLoader.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
