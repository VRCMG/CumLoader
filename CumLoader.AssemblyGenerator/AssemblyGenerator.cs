...
using CumLoader.TinyJSON;
using CumLoader.Tomlyn;
using CumLoader.Tomlyn.Model;
using CumLoader.Tomlyn.Syntax;

namespace CumLoader.AssemblyGenerator
{
    internal static class Main
    {
        ...
        private static void PreSetup(string gameRoot)
        {
            ...
            AssemblyFolder = Path.Combine(gameRoot, "CumLoader", "Managed");

            MSCORLIB_Path = Path.Combine(AssemblyFolder, "mscorlib.dll");
            
            BaseFolder = SetupDirectory(Path.Combine(Path.Combine(Path.Combine(gameRoot, "CumLoader"), "Dependencies"), "AssemblyGenerator"));
